...
class TeacherWeeklyWorkloadConstraint(BaseConstraint):
    """
    Limits the number of sessions
    a teacher can teach in one week.
    """
    ...
    def apply(
        ...
        teacher_week_variables = defaultdict(list)
        ...
        for teacher_id, vars_for_week in teacher_week_variables.items():
